...
def test_is_removed_earliest(bz):
    ...
    assert is_removed_first_diagnosis == True
    assert is_removed_first_sitepatch == False
    assert is_removed_first_empty_added == True
    assert is_removed_first_empty_removed == False
    assert is_removed_first_empty == False
