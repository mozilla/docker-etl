...
class Bug(BaseModel):
    ...
    keywords: list[str]
    url: Text
    user_story: Text = Field(alias="cf_user_story")
    last_resolved: Optional[datetime] = Field(alias="cf_last_resolved", default=None)
    last_change_time: datetime
    ...
    def from_bq_row(cls, row: bigquery.Row) -> Self:
        ...
        quite the inverse of BigQueryImporter.convert_bug."""
...
BUG_QUERIES: Mapping[str, Mapping[str, str | list[str]]] = {
    ...
    "webcompat_other": {
        ...
        "f7": "see_also",
        "o7": "casesubstring",
        "v7": "https://github.com/web-platform-tests/interop/issues/",
        "f8": "keywords",
        "o8": "casesubstring",
        "v8": "web-feature",
        "f9": "CP",
